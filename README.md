...
2. Install Python (3.10 was used to create this, also tested 3.12)
3. Clone/Download this repository and navigate to the directory  containing `main.py`
4. Create a file called `.env` in the same directory level as `main.py`. In this file create a variable called `TARGET_PHONE_NUMBER="9998881234"`. Also create a SSN variable if there is a step to add your SSN during the call (say for customer lookup) `SSN="111223333"`
...
1. Run: `python main.py --method call`
...
## Editor notes ig
1. new --method text added
2. someone spam texted my girl anonymously a disgusting rape fantasy about her so this is me getting back at them
3. don't use this spam text for gross shit like that guy, use it for revenge on people like him.
4. if anyone knows how to track down a voip number's user lmk. asking for a friend.
